...
namespace Wii
{
    public class Tools
    {
        ...
        public static byte[] CharArrayToByteArray(char[] array)
        {
            ...
            {
                converted[i] = Convert.ToByte(array[i]);
            }
...
//            else return new string[8];
    ...
    public class NAND
    {
        ...
        /// <summary>
        /// Checks, if backup data exists in the given title folder
        /// </summary>
        /// <param name="nandpath"></param>
        /// <param name="titlepath">Format: XXXXXXXX\XXXXXXXX</param>
    ...
    public class ThreadFinishEventArgs : EventArgs
    {
        private bool isThreadInterrupted;
        public bool IsThreadInterrupted { get { return isThreadInterrupted; } }

        public ThreadFinishEventArgs(bool isThreadInterrupted) { this.isThreadInterrupted = isThreadInterrupted; }
    }
}